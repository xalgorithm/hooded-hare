 ...
 */
function zen0_theme(&$existing, $type, $theme, $path) {
 ...
 */
function zen0_breadcrumb($variables) {
 ...
 */
function zen0_preprocess_html(&$variables, $hook) {
 ...
 */
function zen0_process_html(&$variables, $hook) {
 ...
 */
function zen0_process_html_tag(&$variables) {
 ...
 */
function zen0_html_head_alter(&$head) {
 ...
 */
function zen0_preprocess_page(&$variables, $hook) {
 ...
 */
function zen0_preprocess_maintenance_page(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("maintenance_page" in this case.)
 */
function zen0_process_maintenance_page(&$variables, $hook) {
 ...
 */
function zen0_preprocess_node(&$variables, $hook) {
 ...
 */
function zen0_preprocess_comment(&$variables, $hook) {
 ...
 */
function zen0_preprocess_region(&$variables, $hook) {
 ...
 */
function zen0_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function zen0_process_block(&$variables, $hook) {
 ...
 */
function zen0_form_node_form_alter(&$form, &$form_state, $form_id) {

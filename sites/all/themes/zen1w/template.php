...
if (theme_get_setting('zen1w_rebuild_registry') && !defined('MAINTENANCE_MODE')) {
  // Rebuild .info data.
 ...
 */
function zen1w_theme(&$existing, $type, $theme, $path) {
 ...
 */
function zen1w_breadcrumb($variables) {
  $breadcrumb = $variables['breadcrumb'];
  $output = '';

  // Determine if we are to display the breadcrumb.
  $show_breadcrumb = theme_get_setting('zen1w_breadcrumb');
  if ($show_breadcrumb == 'yes' || $show_breadcrumb == 'admin' && arg(0) == 'admin') {

    // Optionally get rid of the homepage link.
    $show_breadcrumb_home = theme_get_setting('zen1w_breadcrumb_home');
    ...
    if (!empty($breadcrumb)) {
      $breadcrumb_separator = theme_get_setting('zen1w_breadcrumb_separator');
      $trailing_separator = $title = '';
      if (theme_get_setting('zen1w_breadcrumb_title')) {
        $item = menu_get_item();
      ...
      elseif (theme_get_setting('zen1w_breadcrumb_trailing')) {
 ...
 *   also be "maintenance_page" since zen1w_preprocess_maintenance_page() calls
 *   this function to have consistent variables.
 */
function zen1w_preprocess_html(&$variables, $hook) {
  ...
  $variables['skip_link_anchor'] = theme_get_setting('zen1w_skip_link_anchor');
  $variables['skip_link_text'] = theme_get_setting('zen1w_skip_link_text');
  ...
  if (theme_get_setting('zen1w_wireframes')) {
 ...
 */
function zen1w_process_html(&$variables, $hook) {
 ...
 */
function zen1w_process_html_tag(&$variables) {
 ...
 */
function zen1w_html_head_alter(&$head) {
 ...
 */
function zen1w_preprocess_page(&$variables, $hook) {
 ...
 */
function zen1w_preprocess_maintenance_page(&$variables, $hook) {
  zen1w_preprocess_html($variables, $hook);
  // There's nothing maintenance-related in zen1w_preprocess_page(). Yet.
  //zen1w_preprocess_page($variables, $hook);
}
 ...
 *   The name of the template being rendered ("maintenance_page" in this case.)
 */
function zen1w_process_maintenance_page(&$variables, $hook) {
  zen1w_process_html($variables, $hook);
 ...
 */
function zen1w_preprocess_node(&$variables, $hook) {
 ...
 */
function zen1w_preprocess_comment(&$variables, $hook) {
 ...
 */
function zen1w_preprocess_region(&$variables, $hook) {
 ...
 */
function zen1w_preprocess_block(&$variables, $hook) {
  ...
  // The last_in_region property is set in zen1w_page_alter().
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function zen1w_process_block(&$variables, $hook) {
 ...
 */
function zen1w_page_alter(&$page) {
 ...
 */
function zen1w_form_node_form_alter(&$form, &$form_state, $form_id) {
